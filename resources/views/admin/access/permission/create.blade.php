      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group m-form__group">
            <label for="parent_id" class="form-control-label">Modules: <i class="text-danger">*</i></label>
            <select name="parent_id" data-rule-required="false" data-placeholder="Select Permission"
              style="width: 100%;" data-url="{{ route('admin.get.permission', ['parent' => true]) }}" id="parent_id"
              class="form-control">
