          ...
          <div class="card-body">
            ...
            <div class="form-row">
              <div class="form-group col">
                ...
                <input type="text" data-rule-required="true" class="form-control"
                  data-rule-remote="{{ route('admin.user.email.unique') }}" data-msg-remote="This email already exists"
            ...
            <div class="form-row">
              <div class="form-group col">
                ...
                <input type="password" data-rule-required="true" class="form-control" name="password" id="password"
            ...
            <div class="form-row">
              <div class="form-group col">
                ...
                <select name="permission[]" data-rule-required="false" multiple data-placeholder="Select Permission"
                  id="permission" data-url="{{ route('admin.get.permission') }}" id="permission" class="form-control">
