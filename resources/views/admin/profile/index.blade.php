        ...
        <div class="card">
          <div class="card-body">
            <div class="text-center" id="tag_container">
              <img src="{{ $profile->profile_src ?? '' }}" class="rounded-circle profile-user-img" style="width:150px;"
                id="showcropimg">
              ...
              <div class="active tab-pane" id="profiletab">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col">
                    <label for="last_name" class="col-sm-1-12 col-form-label">Last Name <i
                        class="text-danger">*</i></label>
                    <input type="text" data-rule-required="true" value="{{ $profile->last_name }}" class="form-control"
                ...
                <div class="form-row">
                  <div class="form-group col">
                    ...
                    <input type="text" data-rule-required="true" class="form-control"
                      ...
                      value="{{ $profile->email }}" data-msg-remote="This email already exists" name="email" id="email"
                ...
                <div class="form-row">
                  <div class="form-group col">
                    ...
                    <input type="password" data-rule-required="true" class="form-control" name="old_password"
                      id="old_password" placeholder="Old Password">
                  </div>
                  <div class="form-group col">
                    <label for="new_password" class="col-sm-1-12 col-form-label">New Password </label>
                    <input type="password" data-rule-required="true" class="form-control" name="new_password"
                      id="new_password" placeholder="New Password">
                  </div>
                  <div class="form-group col">
                    <label for="confirm_password" class="col-sm-1-12 col-form-label">Confirm Password
                    </label>
                    <input type="password" data-rule-required="true" class="form-control" name="confirm_password"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <x-button class="btn-primary upload-result btn-primary" type="submit">
            Save
          </x-button>
        </div>
      </div>
