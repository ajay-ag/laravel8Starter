<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index3.html" class="brand-link" style="border-bottom: none;">
    ...
    <span class="brand-text font-weight-light" style=" font-size: 16px; font-weight: 600 !important; ">{{ $general_settings->store_name }}</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
        ...
        <li class="nav-item">
          <a href="{{ route('admin.website-setting') }}" class="nav-link {{ Helper::isActive(['website-setting','website-setting.*','settings.*','smtp.*']) }}">
